...
and tubing to connect to the PSI or our DIY reactor and decrease the
gas flow so that we can measure something. Perhaps add valve control
to measure multiple reactors in series.
...
\item Scale - \obtain{}\\
  ...
  \href{http://www.elecrow.com/weight-sensor-kit-3kg-p-883.html}{Elecrow
    Weight Sensor kit 3kg for Arduino} - \ordered{}
