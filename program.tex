...
\item The \texttt{most creative arduino fry} Award:\\the winning idea will
...
\item The \texttt{[gray|blue|green|red] soldering iron}:\\
  for \texttt{[1|2|4|7]} successfully soldered connections
\item The \texttt{chip monkey} Award
